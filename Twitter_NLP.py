...
def main():
    get_tweet('LeBron_mvp.txt', 'LeBron MVP' or 'lbj MVP')
    get_tweet('curry_mvp.txt', 'curry MVP')
    get_tweet('durant_mvp.txt', 'Durant MVP' or 'KD MVP')

    print('curry', sentiment_analysis('curry_mvp.txt'))
    print('durant', sentiment_analysis('durant_mvp.txt'))
    print('LeBron', sentiment_analysis('LeBron_mvp.txt'))
